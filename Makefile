...
# script 2
data/processed/train_df.csv : scripts/02_split_data.py data/raw/raw_data.csv
    python scripts/02_split_data.py --raw_data=data/raw/raw_data.csv --data_to=data/processed/

data/processed/test_df.csv : scripts/02_split_data.py data/raw/raw_data.csv
    python scripts/02_split_data.py --raw_data=data/raw/raw_data.csv --data_to=data/processed/

data/processed/X_train.csv : scripts/02_split_data.py data/raw/raw_data.csv
    python scripts/02_split_data.py --raw_data=data/raw/raw_data.csv --data_to=data/processed/

data/processed/y_train.csv : scripts/02_split_data.py data/raw/raw_data.csv
    python scripts/02_split_data.py --raw_data=data/raw/raw_data.csv --data_to=data/processed/

data/processed/X_test.csv : scripts/02_split_data.py data/raw/raw_data.csv
    python scripts/02_split_data.py --raw_data=data/raw/raw_data.csv --data_to=data/processed/
...
# script 4
data/processed/train_df.csv : scripts/04_preprocess_and_validate.py data/processed/train_df.csv
    python scripts/02_split_data.py --raw_data=data/raw/raw_data.csv --data_to=data/processed/

data/processed/test_df.csv : scripts/04_preprocess_and_validate.py data/processed/test_df.csv
    python scripts/02_split_data.py --raw_data=data/raw/raw_data.csv --data_to=data/processed/

data/processed/X_train.csv : scripts/04_preprocess_and_validate.py data/processed/X_train.csv
    python scripts/02_split_data.py --raw_data=data/raw/raw_data.csv --data_to=data/processed/

data/processed/X_test.csv : scripts/04_preprocess_and_validate.py data/processed/X_test.csv
    python scripts/02_split_data.py --raw_data=data/raw/raw_data.csv --data_to=data/processed/
...
results/tables/model_scores.csv : scripts/05_dummy.py data/processed/X_train.csv data/processed/y_train.csv
    python scripts/05_dummy.py \
        --x-train-data=data/processed/X_train.csv \
        --y-train-data=data/processed/y_train.csv \
        --model-to=results/models/dummy_classifier.pickle \
...
results/tables/model_scores.csv : scripts/06_tune_and_train.py data/processed/X_train.csv data/processed/y_train.csv
    python scripts/06_tune_and_train.py \
        --x-train-data=data/processed/X_train.csv \
        --y-train-data=data/processed/y_train.csv \
        --model-to=results/models/logreg_classifier.pickle \
...
# script 7
results/tables/model_scores.csv : scripts/07_score.py results/models/dummy_classifier.pickle results/models/logreg_classifier.pickle data/processed/X_test.csv data/processed/y_test.csv results/tables/model_scores.csv
